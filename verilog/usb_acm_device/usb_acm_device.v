...
module usb_acm_device (
    ...
    always @(posedge clk48) begin
        if (uart_in_valid == 1 & reset == 0) begin
            case (reg_counter)
...
//                3'd3 : begin reg1[7:0] <= uart_out_data; uart_in_data <= uart_out_data; end
                3'd0 : begin reg0[15:8] <= uart_out_data; uart_in_data <= 8'h50; end
                3'd1 : begin reg0[7:0] <= uart_out_data; uart_in_data <= 8'h51; end
                3'd2 : begin reg1[15:8] <= uart_out_data; uart_in_data <= 8'h52; end
                3'd3 : begin reg1[7:0] <= uart_out_data; uart_in_data <= 8'h53; end
                3'd4 : begin out_reg <= reg0*reg1; uart_in_data[7:3] <= 5'hA; uart_in_data[3:0] <= reg_counter; end
...
// assign usb_p_in = 1'b0;
// assign usb_n_in = 1'b0  ;
